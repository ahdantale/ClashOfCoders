...
var answerArray = ["WATER COOLER","IDBI ATM","PARKING TREE","STAFF PARKING","TERRACE","DBMS_LAB","STAIRS","POND","HIMALAYA","MH49 AQ1179","Computer science and engineering","FIREPIPE","classroom","main gate","notice board"]

var question1 = "We define f(X,Y) as number of different corresponding bits in binary representation <br>of X and Y. For example, f(2, 7) = 2, since binary representation of 2 and 7 <br>are 010 and 111, respectively. The first and the third bit differ, so f(2, 7) = 2. <br> You are given an array of N positive integers, A 1 , A 2  ,…, A N . Find sum of f(A i , A j ) for <br>all pairs (i, j) such that 1 ≤ i, j ≤ N. Return the answer modulo 10 9 +7. <br>For example, <br> <br>A=[1, 3, 5] <br>We return <br>f(1, 1) + f(1, 3) + f(1, 5) + <br>f(3, 1) + f(3, 3) + f(3, 5) + <br>f(5, 1) + f(5, 3) + f(5, 5) =<br>0 + 1 + 1 +<br>1 + 0 + 2 +<br>1 + 2 + 0 = 8 <br> Array is : A = [12, 34, 86, 91, 30, 85, 27, 90, 43, 28, 78, 54, 21, 83, 99]"
...
var question3 = "Given the number 45869131873649 find the <br> largest possible number in its range. i.e. the first digit should be the same."
